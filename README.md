# HandSign3D
## Instalar
- Descargar apk de releases en Meta Quest 3/3s
- Habilitar instalación de origenes desconocidos
- Habilitar permisos de aplicación.
...
## Creditos
- Modelo 3D hecho por Niclas en [Sketchfab](https://skfb.ly/oHHTN) bajo la licencia de [CC by 4.0](https://creativecommons.org/licenses/by/4.0/)
- Animado por Raiza
